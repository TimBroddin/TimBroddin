...
- 🧰 **[skills](https://github.com/TimBroddin/skills)** — Personal collection of agent skills (Claude Code, Codex, Cursor, …) — currently includes `youtube-research` for deep LLM research over YouTube channels
